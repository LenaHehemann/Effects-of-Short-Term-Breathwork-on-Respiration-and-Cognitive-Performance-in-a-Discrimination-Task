% % This function is a modified version of fdr_bh() by David M. Groppe.
% 
% Original function:
...
%
% Usage:
%  >> [h, crit_p, adj_ci_cvrg, adj_p]=ck_stat_fdr(pvals,q,method,report);
%
% Required Input:
...
function [h, crit_p, adj_ci_cvrg, adj_p]=ck_stat_fdr(pvals,q,method,report)
